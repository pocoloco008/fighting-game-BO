...
public class Player2Movement : MonoBehaviour
{
    ...
    public int playerIndex = 1; // Staat op 1 voor Player 2

    private Rigidbody2D rb;
    private Gamepad myGamepad;
    private Vector2 moveInput;

    private bool facingRight = false; // Check of Player 2 standaard een andere kant op kijkt, pas dit evt. aan
